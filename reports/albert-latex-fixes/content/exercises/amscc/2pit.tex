...
\theme{Série entière, équation différentielle}
\datecreate{2024-06-01}
...
\item \question{En déduire une expression explicite de $(a_n)_{n\geq 2}$ puis l'expression générale de la solution $y$. On précisera l'intervalle de convergence de la série obtenue.}
