...
\contenu{
\texte{Montrer que les ensembles ci-dessous sont des espaces vectoriels (sur $\Rr$) :}
\begin{enumerate}
    \item \question{$E_1 = \big\{ f : [0,1] \to \Rr \big\}$ : l'ensemble
...
muni de l'addition $f+g$ des fonctions et de la multiplication par un nombre r\'eel $\lambda \cdot f$.}
    \item \question{$E_2 = \big\{ (u_n) : \Nn \to \Rr \big\}$ : l'ensemble
...
et de la multiplication par un nombre r\'eel $\lambda \cdot (u_n) = (\lambda \times u_n)$.}
    \item \question{$E_3 = \big\{ P \in \Rr[x] \mid \deg P \le n \big\}$ : l'ensemble des polynômes
