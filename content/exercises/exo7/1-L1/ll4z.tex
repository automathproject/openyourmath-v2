...
\contenu{
\texte{Soit $E=\Rr[X]$ le $\Rr$-espace vectoriel des polynômes à coefficients réels.}
\begin{enumerate}
    \item \question{Soit $\begin{array}[t]{cccc}f~:&E&\rightarrow&E\\ &P&\mapsto&P'\end{array}$. $f$ est-elle linéaire, injective,
surjective~?~Fournir un supplémentaire de $\mbox{Ker}f$.}
    \item \question{Mêmes questions avec $\begin{array}[t]{cccc}g~:&E&\rightarrow&E\\ &P&\mapsto&\int_{0}^{x}P(t)\;dt\end{array}$.}
\end{enumerate}
\reponse{
