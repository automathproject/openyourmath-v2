...
\contenu{
\begin{enumerate}
    \item \question{Soit $P\in\C[X]$ admettant deux racines distinctes et tel que $P''$
    divise $P$. Montrer que $P$ est {\`a} racines simples.}
    \item \question{Soit $P\in\R[X]$ admettant deux racines r{\'e}elles distinctes, et tel que
