...
\begin{enumerate}
    ...
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.5]{images/pdf/0wvO-1.pdf}\end{center}
        \caption{}
    \end{figure}
    
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.5]{images/pdf/0wvO-2.pdf}
            \caption{le point $O$ est à l'infini}\end{center}
    \end{figure}
    
    \begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.4]{images/pdf/0wvO-3.pdf}
...
\begin{figure}[!ht] 
        \begin{center}\includegraphics[scale=0.6]{images/pdf/0wvO-4.pdf}\end{center}
        \caption{}
    \end{figure}
