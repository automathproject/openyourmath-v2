...
\contenu{
\texte{({\it 9 points}) Soit $u$ l'endomorphisme de $\R^3$, dont la matrice dans la base canonique est
$$A=\begin{pmatrix}3&2&-2 \\  -1&0&1 \\ 1&1&0 \\ \end{pmatrix}$$ 
\begin {enumerate}}
\begin{enumerate}
    \item \question{Calculer les valeurs propres de $A$. L'endomorphisme $u$ est-il diagonalisable ?}
    \item \question{Calculer $(A-I)^2$. Montrer que $A^n=nA+(1-n)I$ en utilisant la formule du bin\^ome de Newton.}
    \item \question{Soient $P(X)=(X-1)^2$ et $Q\in\R[X]$. Exprimer le reste de la division euclidienne de $Q$ par $P$ en fonction de $Q(1)$ et $Q'(1)$, o\`u $Q'$ est le polyn\^ome d\'eriv\'e de $Q$. En remarquant que $P(A)=0$ et en utilisant le r\'esultat pr\'ec\'edent avec un choix judicieux du polyn\^ome 
$Q$, retrouver $A^n$.}
    \item \question{\begin {enumerate}}
    \item \question{Montrer que l'image de $\R^3$ par l'endomorphisme $u-\mathrm{Id}$ est un sous-espace vectoriel de dimension $1$, on notera $\varepsilon_2$ une base.}
    \item \question{D\'eterminer un vecteur $\varepsilon_3$ tel que 
$u(\varepsilon_3)=\varepsilon_2+\varepsilon_3$. D\'eterminer un vecteur propre $\varepsilon_1$  de $u$ non colin\'eaire \`a $\varepsilon_2$.}
    \item \question{Montrer que $(\varepsilon_1,\varepsilon_2,\varepsilon_3)$ est une base de $\R^3$.Ecrire la matrice de $u$ dans cette base, ainsi que les matrices de passage.}
    \item \question{Retrouver $A^n$.
  \end {enumerate}
\end {enumerate}}
\end{enumerate}
\reponse{
