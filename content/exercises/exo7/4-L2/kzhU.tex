...
\contenu{
\texte{Soit $f$ un endomorphisme de $E$ v\'erifiant $f^2={\rm mathrm{Id}}_E$.
\begin {enumerate}}
\begin{enumerate}
    \item \question{D\'emontrer que les seules valeurs propres possibles de $f$ sont $1$ et $-1$.}
    \item \question{V\'erifier que pour tout $\vec x\in E$, on a
$$f(\vec x-f(\vec x))=-(\vec x-f(\vec x))\ \ {\hbox{et}}\ \ f(\vec x+f(\vec x))=(\vec x+f(\vec x))$$
et en d\'eduire que $f$ admet toujours une valeur propre.}
    \item \question{D\'emontrer que si $1$ et $-1$ sont valeurs propres, alors $E$ est somme directe des sous-espaces propres correspondants.}
    \item \question{Traduire g\'eom\'etriquement sur un dessin dans le cas $n=2$.
\end {enumerate}}
\end{enumerate}
\reponse{
