...
\contenu{
\begin{enumerate}
    \item \question{Déterminer $\lim_{x\rightarrow 1}\int_{x}^{x^2}\frac{dt}{\ln t}$.}
    \item \question{Etude complète de $F(x)=\int_{x}^{x^2}\frac{dt}{\ln t}$.}
\end{enumerate}
\reponse{
...
$$\includegraphics{../images/pdf/Rs3w-1.pdf}$$
}
}
