...
\contenu{
\texte{Soit $a$ un r{\'e}el dans $]0,1[$. On souhaite calculer l'int{\'e}grale
...
\begin{enumerate}
    \item \question{Montrer que $f$ est m{\'e}romorphe sur $\Omega $. Quels en sont les p{\^o}les ?}
    \item \question{Soit $\varepsilon\in\left]0,1\right[$ et $R>1$ deux r{\'e}els.
