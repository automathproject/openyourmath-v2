...
\contenu{
\texte{Soit $R$ une fraction rationnelle, ou plus g{\'e}n{\'e}ralement une fonction
 m{\'e}romorphe sur $\C$, sans p{\^o}le r{\'e}el.}
\begin{enumerate}
    \item \question{On souhaite calculer
...
contour form{\'e} du bord du quart de cercle  $\{ 0< \arg z<{\pi \over 2}, |z|<a\}$.}
    \item \question{Application: calculer
$$  \int_0^{+\infty } {x\over 1+x^8}\,dx .$$}
    \item \question{Plus g{\'e}n{\'e}ralement, montrer que si $n$ et $p$ sont des entiers, et $p\geq 3$, on
peut calculer
