...
\contenu{
\texte{Sur l'{\'e}cran d'un oscilloscope on observe la courbe dont les {\'e}quations
...
\begin{enumerate}
    \item \question{Exprimer puis factoriser la somme et la diff{\'e}rence $x+y$ et $x-y$.}
    \item \question{Soient $X$ et $Y$ les coordonn{\'e}es par rapport aux axes d{\'e}duits des axes ${\rm
...
$\pi/2$ et les r{\'e}gions qu'elles d{\'e}limitent).}
    \item \question{La courbe {\'e}tant
