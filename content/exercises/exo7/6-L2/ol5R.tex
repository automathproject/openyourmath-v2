...
\contenu{
\texte{Trouver une équation du plan $(P)$ 
défini par les éléments suivants, où $A$, $B$ et $C$ sont des points de $(P)$.}
\begin{enumerate}
...
(car l'équation est unique à un facteur multplicatif non nul près). On trouve : $x+y+z-1=0$}
