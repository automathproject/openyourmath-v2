...
\contenu{
\texte{Un cercle de rayon $R$ roule sans glisser sur l'axe ${\rm O}x$ dans le sens des
...
l'axe ${\rm O}x$.}
\begin{enumerate}
    \item \question{D{\'e}terminer l'abscisse de $\Omega(\theta)$ et les coordonn{\'e}es
...
pr{\'e}ciser sa position sur cette droite.}
    \item \question{(facultatif) L'angle de rotation
