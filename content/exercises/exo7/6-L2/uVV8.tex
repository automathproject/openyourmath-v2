...
\contenu{
\texte{Soit $\cal P$ la parabole d'{\'e}quation $y^2=2px, p>0$.}
\begin{enumerate}
    \item \question{Montrer que la tangente {\`a} $\cal P$ au point ${\rm M}_{0}= (x_{0},y_{0})$
a pour {\'e}quation $yy_{0}=p(x+x_{0})$.}
    \item \question{Un rayon lumineux, port{\'e} par la
