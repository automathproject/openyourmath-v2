...
\contenu{
\texte{Un segment AB de longueur $l$ se d{\'e}place dans le plan de fa\c{c}on que le point
...
qu'il d{\'e}crit.}
\begin{enumerate}
    \item \question{A l'instant z{\'e}ro un oiseau s'envole d'un point A d'un
...
par $A(0,0,a)$, $B(b,0,0)$, $\overrightarrow{v}=(0,v,0)$ avec~:}
    \item \question{Envol {\`a} partir du repos~:
$a$=15m, $b$=10m, $v$=5m/s, $u$=300m/s}
    \item \question{Passage en plein vol~: 
