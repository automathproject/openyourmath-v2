...
\contenu{
\texte{On dispose d'un oscilloscope {\`a} deux voies. On applique sur la voie X une
...
\begin{enumerate}
    \item \question{D{\'e}terminer la p{\'e}riode du mouvement T.}
    \item \question{Donner le tableau des
variations de $x(t)$ et $y(t)$ sur l'intervalle [0,T], et en d{\'e}duire l'allure
de la courbe.}
    \item \question{D{\'e}terminer les coordonn{\'e}es des points de la courbe
d'abscisse ou d'ordonn{\'e}e maximum.}
    \item \question{D{\'e}terminer les sym{\'e}tries de la
