...
y=(t-2)e^{1/t}
\end{array}\right.$}
\reponse{$$\includegraphics{../images/pdf/4Fy0-3.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=(t-1)\ln(|t|)\\
y=(t+1)\ln(|t|)
\end{array}\right.$}
\reponse{$$\includegraphics{../images/pdf/4Fy0-4.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=\frac{2t}{1+t^2}\\
y=\frac{t+2}{1-t^2}
\end{array}\right.$}
...
$$\includegraphics{../images/pdf/4Fy0-5.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=\frac{t}{t^2-1}\\
y=\frac{t+2}{(t-1)^2}
\end{array}\right.$}
\reponse{$$\includegraphics{../images/pdf/4Fy0-6.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=\frac{t^3}{t^2-9}\\
y=\frac{t(t-2)}{t-3}
\end{array}\right.$}
...
$$\includegraphics{../images/pdf/4Fy0-7.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=\frac{t^3}{1+3t}\\
y=\frac{3t^2}{1+3t}
\end{array}\right.$}
...
$$\includegraphics{../images/pdf/4Fy0-8.pdf}$$}
    \item \question{$\left\{\begin{array}{l}
x=t^2+t^3\\
y=t^2+t^3-2t^4-2t^5
\end{array}\right.$}
...
$$\includegraphics{../images/pdf/4Fy0-9.pdf}$$}
\end{enumerate}
}
