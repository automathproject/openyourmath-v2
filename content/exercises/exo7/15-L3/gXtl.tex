...
$S(x)_0=0$.}
    \item \question{$X={\cal C}([0,1])$ muni de la norme $\|.\|_\infty$ et $Tf(x) = f(x)g(x)$ o\`u $g\in X$.}
    \item \question{Calculer la norme des formes lin\'eaires suivantes: $X={\cal C}([0,1])$  muni de la norme $\|.\|_\infty$ et $u(f) = \int _0^1 f(x)g(x) \; dx$ o\`u $g\in X$ est
une fonction qui ne s'annule qu'en $x=1/2$.}
    \item \question{$X= l^2$ et $u(x) = \sum a_nx_n$ o\`u $(a_n)$ est dans $X$.}
    \item \question{$X= l^1$ et $u(x) = \sum a_nx_n$ o\`u $(a_n)$ est dans $l^\infty$.}
    \item \question{$X$ l'espace des suites convergentes muni de la norme sup et $u:X\to \Rr$
