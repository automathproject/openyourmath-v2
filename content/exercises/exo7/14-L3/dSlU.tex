...
\contenu{
\texte{Soit $k\in\N$ et $\alpha\in\left]0,1\right]$.
...
\begin{enumerate}
    \item \question{Soit $f\in L^1(\R)$ {\`a} support compact, et $g
\in C^{0,\alpha}(\R)$. Montrer que $f*g \in
C^{0,\alpha}(\R)$.
 En d{\'e}duire que si $g\in C^{k,\alpha}(\R)$,
alors $f*g \in C^{k,\alpha}(\R)$.}
    \item \question{Soit $f\in L^1(\R)$ {\`a} support quelconque, et $g
