...
\contenu{
\texte{Construire la courbe paramétrée
...
de deux façons~:}
\begin{enumerate}
    \item \question{En se ramenant au calcul de $\int_0^{2\pi}\frac{dt}{(1+\lambda\cos t)^2}$.}
    \item \question{En reconnaissant la nature géométrique de $C$.}
\end{enumerate}
\reponse{
