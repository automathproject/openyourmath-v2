...
$$\includegraphics{../images/pdf/dVYA-1.pdf}$$
...
$$\includegraphics{../images/pdf/dVYA-2.pdf}$$
...
$$\includegraphics{../images/pdf/dVYA-3.pdf}$$


\textbf{Graphe}.

$$\includegraphics{../images/pdf/dVYA-4.pdf}$$
...
$$\includegraphics{../images/pdf/dVYA-5.pdf}$$

\textbf{Graphe.}

$$\includegraphics{../images/pdf/dVYA-6.pdf}$$
...
$$\includegraphics{../images/pdf/dVYA-7.pdf}$$
...
$$\includegraphics{../images/pdf/dVYA-8.pdf}$$



\textbf{Graphe.}

$$\includegraphics{../images/pdf/dVYA-9.pdf}$$



%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_7(x)=e^{/\ln x}$.}
\reponse{$$\includegraphics{../images/pdf/dVYA-10.pdf}$$
...
\reponse{$$\includegraphics{../images/pdf/dVYA-11.pdf}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{11}(x)=\Arcsin\sqrt{\frac{1}{2}-x}+\Arcsin\sqrt{\frac{1}{2}+x}$.}
\reponse{$$\includegraphics{../images/pdf/dVYA-12.pdf}$$


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%}
    \item \question{$f_{12}(x)=\frac{\Arcsin x}{x}$.}
\reponse{$$\includegraphics{../images/pdf/dVYA-13.pdf}$$
...
\reponse{$$\includegraphics{../images/pdf/dVYA-14.pdf}$$}
\end{enumerate}
}
