...
\reponse{Pour tout $n\geq 1$ :
  \begin{align*}
    ...
    \end{align*}
    Remarquons que pour tout $k\in \interent{n+1 2n}$, on a, par décroissance de la fonction inverse sur $\R_+^*$ :
...
\reponse{
Supposons par l'absurde que la limite de $(h_n)$ soit finie. On la note $\ell$. Mais alors \[ h_n \underset{n\to +\infty}{\longrightarrow} \ell \qeq h_{2n}\underset{n\to +\infty}{\longrightarrow} \ell \]
  $(h_{2n})$ étant une suite extraite de la suite $h$, elle a la même limite. Mais alors \[ h_{2n}-h_n \underset{n\to +\infty}{\longrightarrow} 0. \]
