...
\contenu{
\question{Traiter les limites de l'exercice 10 en utilisant les négligeabilités et équivalences (sauf limites $4$ et $5$).}
\reponse{
...
\begin{enumerate}
  ...
  \item Ici, en utilisant les comparaisons, $u_n\underset{+\infty}{\sim} \frac{-5^n}{2\times 5^n}=-\frac{1}{2}$ et donc $u_n \underset{n\to+\infty}{\longrightarrow} -\frac{1}{2}$
  \item Enfin, $u_n\underset{+\infty}{\sim} \frac{-4^n}{7^n}=-\left(\frac{4}{7}\right)^n \underset{n\to+\infty}{\longrightarrow} 0$ (car $-1<\frac47<1$) et donc $\ds{\lim_{n\to +\infty} u_n=0}$
\end{enumerate}
}
}
