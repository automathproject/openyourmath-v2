...
\reponse{De même :
	...
	Puisque $n\underset{n\to +\infty}{\longrightarrow} +\infty$, par produit \[ \lim_{n\to +\infty} n\left(1+\frac{2}{n}-\frac{6}{n}\right)=+\infty \]
Par quotient, $\ds{\lim_{n\to +\infty} u_n=0}$.}
\question{$u_n=3n+1+\dfrac{-3}{n^{2}+1}$}
\reponse{Enfin, $n^2+1\underset{n\to \infty}{\longrightarrow} +\infty$ par somme. Par quotient, \[ \lim_{n\to +\infty} \frac{-3}{n^2+1} = 0 \]
	De plus, $3n+1\underset{n\to+\infty}{\longrightarrow} +\infty$ par somme. On conclut donc par somme que $\ds{\lim_{n\to +\infty} u_n=+\infty}$}
}
