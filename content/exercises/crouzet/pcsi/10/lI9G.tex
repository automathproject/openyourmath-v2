...
\reponse{Démontrons que $(u_n)_{n\geq 1}$ est croissante, $(v_n)_{n\geq 1}$ est décroissante et que $v_n-u_n\underset{n\to+\infty}{\longrightarrow} 0$.
...
\end{align*}
La suite $v$ est donc décroissante. Enfin \[ v_n-u_n=\frac1n\underset{n\to+\infty}{\longrightarrow} 0 \]
