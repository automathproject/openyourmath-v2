...
\reponse{D'après la question \ref{td11-9-q5}, la suite $(u_n)$ est décroissante. D'après la question \ref{td11-9-q2}, elle est minorée par $2$. D'après le théorème de la limite monotone, on en déduit que la suite $(u_n)$ est convergente.\\
		Notons $\ell$ sa limite. Par somme et produit, on a \[ \frac12 u_n^2-\frac32 u_n+3 \underset{n\to+\infty}{\longrightarrow} \frac12 \ell^2-\frac32 \ell+3 \]
