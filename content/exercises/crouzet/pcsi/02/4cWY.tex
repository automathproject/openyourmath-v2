...
\reponse{Remarquons que, si $x\in \Z$, alors $\lfloor x\rfloor + \lfloor -x\rfloor = x-x=0$.
...
\reponse{Soit $n\in \Z$ et $x\in \R$. Puisque $\lfloor x\rfloor \leq x < \lfloor x\rfloor +1$, on a \[ \lfloor x\rfloor + n \leq x+n < \left(\lfloor x\rfloor +n \right)+1.\]
