...
\begin{itemize}
  ...
  Réciproquement, soit $x\in \R*$. Si $x>0$, puisque $k\underset{k\to +\infty}{\longrightarrow} +\infty$ et $\frac{1}{k} \underset{k\to +\infty}{\longrightarrow} 0$, il existe un entier $p$ tel que $\frac{1}{p} < x \leq p$. Mais alors $x\in \interof{\frac{1}{p} p}$ et donc $x$ est dans l'union. Le cas $x<0$ se traite de la même manière.
\end{itemize}
}
}
