...
\contenu{
\texte{{
Soit $E$ un ensemble. Pour toutes parties $A$ et $B$ de $E$, on note $A\,\Delta\, B=(A\setminus B)\cup(B\setminus A)$ la différence symétrique de $A$ et $B$.}
\question{Déterminer $A\,\Delta\, A$ et $A\,\Delta\, \vide$.}
\reponse{Par définition, $A\Delta A = \vide$ et $A\Delta \vide=A$.}
\question{Montrer que $A\,\Delta\, B = (A\cup B)\setminus (A\cap B)$.}
...
\question{Montrer que $\overline{A\,\Delta\, B} = (A\cap B) \cup (\overline{A\cup B})$.}
\reponse{Par définition de la différence, on a $A \Delta B = (A\cup B) \cap (\overline{A\cap B})$ d'après la question précédente. D'après les lois de de Morgan :
	...
	\end{align*}}
\question{Soit $D$ une partie de $A$. Montrer que $A\,\Delta\, B=A\,\Delta\, D$ si et seulement si $B=D$.
}}
}
