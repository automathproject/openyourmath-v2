...
Soit $a<b$. Prenons $f:\interff{0 1} \to \interff{a b}$ définie par $f:x\mapsto (b-a)x+a$. Alors $f$ est strictement croissante (car $b-a>0$) donc injective. De plus, soit $y\in \interff{a b}$ :
	\begin{align*}
...
\reponse{Soit $f:\interof{0 1} \to \interfo{0 +\infty}$ définie par $f:x\mapsto \frac{1}{x}-1$. $f$ est bijective; en effet, soit $y\in \interfo{0 +\infty}$ :
	\begin{align*}
