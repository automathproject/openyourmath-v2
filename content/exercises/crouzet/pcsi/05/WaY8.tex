...
\reponse{On raisonne par inégalité :
  ...
  \begin{align*}
    ...
    &\Leftrightarrow \mathrm{e} \leq x^2+1 \leq 10 \text{ car $\exp$ est bijective}\\
    &\Leftrightarrow \mathrm{e} - 1 \leq x^2 \leq 9 \\
    &\Leftrightarrow x \in \interff{-3 -\sqrt{\mathrm{e}-1}} \cup \interff{\sqrt{{\mathrm{e}-1}} 3}
  \end{align*}
  Ainsi, \[ f^{-1}\left(\interff{1 \ln(10)}\right) = \interff{-3 -\sqrt{\mathrm{e}-1}} \cup \interff{{\sqrt{\mathrm{e}-1}} 3} .\]
