...
\reponse{Par définition et unicité de la limite, les $(L_k)$ sont deux à deux disjoints. Elles sont non vides (les suites constantes égales à $k$, avec $k\in \Z$, convergent vers $k$). Intuivivement, \[ L = \bigcup_{k\in \Z} L_k \]
