...
\reponse{Soit $P$ la proposition définie pour tout entier $n$ par $P_n:$ ~``$u_n>n^2$''.
		\begin{itemize}
...
\reponse{Après calcul des premières valeurs, il semblerait que $u_n=(n+1)^2$. Montrons-le par récurrence.
