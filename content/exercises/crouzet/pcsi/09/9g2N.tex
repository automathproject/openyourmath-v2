...
\reponse{Soit $P$ la proposition définie pour tout entier $n$ par $P_n$ : ``$u_n$ existe et $u_n>0$''. Démontrons $P$ par récurrence double.
...
\reponse{$w$ est bien définie d'après ce qui précède. Constatons alors que, pour tout entier $n$,
