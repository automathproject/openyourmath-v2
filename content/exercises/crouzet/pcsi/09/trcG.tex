...
\reponse{$u$ est récurrente linéaire d'ordre $2$. En introduisant $(E)$ l'équation caractéristique $X^2=-2X+15$, de racines $-5$ et $3$. Ainsi, il existe $a$ et $b$ tels que, pour tout $n$, $u_n=a(-5)^n+b3^n$. En utilisant $u_0=1$ et $u_1=2$, on obtient le système
...
\reponse{De la même manière, $u$ est récurrente linéaire d'ordre $2$, d'équation caractéristique $X^2=8X-16$, qui admet comme unique racine $4$. Ainsi, il existe deux réels $a$ et $b$ tels que, pour tout $n$, $u_n=(an+b)4^n$. En utilisant $u_0$ et $u_1$, on obtient le système
