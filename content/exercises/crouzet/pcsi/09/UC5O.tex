...
\reponse{Soit $P$ la proposition définie pour tout entier $n$ par $P_n:$ ~``$1\leq u_n\leq 3$''.
		\begin{itemize}
...
\reponse{Soit $Q$ la proposition définie pour tout entier $n$ par $Q_n:$ ~``$u_n\leq u_{n+1}$''.
		\begin{itemize}
