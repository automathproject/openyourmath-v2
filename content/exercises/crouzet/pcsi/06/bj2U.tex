...
\end{align*}
Enfin, racine est définie sur $\R^+$ et dérivable sur $\R_+^*$. $x\mapsto \ln(1+x)$ est définie et dérivable sur $\interoo{-1 +\infty}$. Ainsi, $h$ est définie sur $\R^+$ et est dérivable  sur $\R_+^*$. On a alors :
\begin{align*}
