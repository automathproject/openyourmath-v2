...
\reponse{Pour $m$ fixé \textbf{non nul}, il faut donc résoudre l'équation du second degré $mx^2+x(2m-1)-2=0$ d'inconnue $x$. Son discriminant vaut \[\Delta=(2m-1)^2-4m(-2)=4m^2-4m+1+8m=4m^2+4m+1=(2m+1)^2\]
...
\reponse{Pour $x$ fixé, c'est une équation du premier degré en $m$. Ainsi 
