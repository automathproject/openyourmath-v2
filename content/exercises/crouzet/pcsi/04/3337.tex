...
\titre{Des polynômes}
\contenu{
\question{Existe-t-il un polynôme $P\in \R_3[X]$ vérifiant $P(1)=P(-1)=P'(1)=1$ ?

Existe-t-il un polynôme $P\in \R_3[X]$ vérifiant, pour tout entier $k\in \interent{0 3}$, $P(k)=k$ ?}
