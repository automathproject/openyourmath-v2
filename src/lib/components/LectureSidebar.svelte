...
<style>
  .lecture-sidebar {
    ...
    top: 0;
    align-self: stretch;
    min-height: calc(100vh - var(--spacing-header) - 256px);
    max-height: 100vh;
    overflow-y: auto;
    background: #f7f1e4;
  ...
  .metadata-uuid {
    ...
    color: var(--color-interface-text-muted) !important;
  }
  ...
  .video-embed {
    ...
    box-shadow: inset 0 0 0 1px var(--color-interface-border-primary);
  }
